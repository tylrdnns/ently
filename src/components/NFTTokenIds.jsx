            ...
            NFTCollections?.map((nft, index) => (
              <Card
                ...
                cover={
                  <Carousel
                    ...
                    <img 
                      alt="example" 
                      src="https://mobizent.net/wp-content/uploads/2018/04/Home-Four-Banner-Background-Image.png" />
                    <img 
                      alt="example" 
                      src="https://mobizent.net/wp-content/uploads/2018/04/Home-Four-Banner-Background-Image.png" />
                    <img 
              ...
              >
                <div style={styles.bio}>
                  <Meta
                    title={<h1><b>Hidden in Plain Sight</b></h1>}
                    description="(Honoring Rep. John Lewis)"
                  />
                  <div style={styles.avatarBio}>
                    <Avatar 
                      style={styles.avatar1}
                      src="https://www.drummerworld.com/drummerworld1/trevorlawrence840.jpg"/>
                    <Text styles={styles.artist}><b>Trevor Lawrence Jr.</b></Text>
                  </div>
                </div>
                <Meta
                  style={styles.cardDetails}
                  title="About"
                  description="This first-of-it's kind collection and fundraiser comes on the heels of Trevor Lawrence Jr's historic performance in this year's Super Bowl halftime show. This is your chance to be a patron"
                />
                <div style={styles.dropDown}>
                  {show ? 
                    <div>
                      <Meta style={styles.cardDetails} title="Details"/> 
                      <ul>Album:
                          <li><em>Free Will</em>, by Trevor Lawrence, Jr</li>
                          <li><em>Modern Vamp</em>, by Trevor Lawrence, Jr</li>
                          <li><em>Good Trouble</em>, by Trevor Lawrence, Jr (ft. Mark Cargill</li>
                          <li><em>Selma</em>, by Trevor Lawrence, Jr (ft. Terrance Martin)</li>
                          <li><em>Jesus, The Light of the World</em>, by Trevor Lawrence, Jr</li>
                          <li><em>The Council</em>, by Trevor Lawrence, Jr (ft. Terrance Martin)</li>
                          <li><em>This Little Light of Mine</em>, by Trevor Lawrence, Jr</li>
                      </ul>
                      <ul>Release Date:
